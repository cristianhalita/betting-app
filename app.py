...
# CSS pentru inputuri fără butoane +/- și etichete verzi
st.markdown("""
    <style>
    /* Text verde pentru etichete */
    label, .css-1cpxqw2 {
